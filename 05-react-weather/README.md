...
Create an account on [OpenWeatherMap.org](https://openweathermap.org/) and create an API key: [https://home.openweathermap.org/api_keys](https://home.openweathermap.org/api_keys). Note that it takes ~15 minutes for the key to start working!
